...
namespace DeviceDetectorNET.Parser.Device
{
    public static class Devices
    {
        ...
        /// </summary>
        public static readonly Dictionary<string, int> DeviceTypes = new Dictionary<string, int>
        {
            ...
            { "peripheral", DeviceType.DEVICE_TYPE_PERIPHERAL }
        };
        ...
        /// </summary>
        public static readonly Dictionary<string, string> DeviceBrands = new Dictionary<string, string>
        {
            { "5E", "2E" },
            { "5IV", "5IVE" },
            { "2F", "F2 Mobile" },
        ...
        public static readonly IReadOnlyDictionary<string, int> ClientHintFormFactorsMapping = new Dictionary<string, int>
        {
            { "automotive", DeviceType.DEVICE_TYPE_CAR_BROWSER },
            { "xr", DeviceType.DEVICE_TYPE_WEARABLE },
            { "watch", DeviceType.DEVICE_TYPE_WEARABLE },
            { "mobile", DeviceType.DEVICE_TYPE_SMARTPHONE },
            { "tablet", DeviceType.DEVICE_TYPE_TABLET },
            { "desktop", DeviceType.DEVICE_TYPE_DESKTOP },
            { "eink", DeviceType.DEVICE_TYPE_TABLET },
        };
        ...
        /// </summary>
        public static readonly Dictionary<string, string> LegacyShortNames = new Dictionary<string, string>
        {
            // Is now '2E'
            { "6T", "Twoe" },
            // Is now 'ARRIS'
        ...
        /// </summary>
        /// <returns>List of all available device types</returns>
        ...
        {
            return DeviceTypes.ContainsValue(deviceType)
                ? DeviceTypes.FirstOrDefault(t => t.Value.Equals(deviceType)).Key
                :string.Empty;
        }
        ...
        public static string GetFullName(string brandId)
        {
            if (string.IsNullOrEmpty(brandId))
                return string.Empty;
            return DeviceBrands.TryGetValue(brandId, out var brand) ? brand : string.Empty;
        }
        ...
        {
            var shortcode = DeviceBrands.ContainsValue(brand) 
                ? DeviceBrands.FirstOrDefault(x => x.Value == brand).Key 
                : string.Empty;
            if (!string.IsNullOrEmpty(shortcode))
                return shortcode;
            return LegacyShortNames.ContainsValue(brand) 
                ? LegacyShortNames.FirstOrDefault(x => x.Value == brand).Key 
                : string.Empty;
        }
    }
}